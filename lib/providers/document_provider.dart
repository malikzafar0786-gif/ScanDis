...
class DocumentProvider extends ChangeNotifier {
  ...
  /// Unfiltered — ignores the active folder/favorites/search filters.
  /// Used by features (like Bill Reminders) that need every document
  /// regardless of what's currently selected on the Home screen.
